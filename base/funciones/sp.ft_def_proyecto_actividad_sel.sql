    ...
    THEN
      ...
      BEGIN
        ...
        v_consulta:=' SELECT
          ...
          when id_actividad_padre is not NULL and tad.nivel>1 and (tad.id_tipo = 4 or tad.id_tipo = 1) then --or tad.id_tipo = 1 or tad.id_tipo = 3 ) then --AGREGANDO A LA CONSTRUCCION MAS
             tpsa.porcentaje_avance::numeric
          end  as porcentaje,
