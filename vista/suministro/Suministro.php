...
console.log('datos',config.data.datos_originales.data.id_def_proyecto);
		this.load({params:{start:0, limit:this.tam_pag,id_def_proyecto:config.data.datos_originales.data.id_def_proyecto}})
	},
...

		{
			config:{
                ...
                renderer: function (value, p, record, rowIndex, colIndex){
                    ...
                    if(record.data.documento_emarque != 'summary'){
		...
		},
		{
			config:{
                ...
                renderer: function (value, p, record, rowIndex, colIndex){
                    ...
                    if(record.data.invitacion != 'summary'){
		...
		},
		{
			config:{
                ...
                renderer: function (value, p, record, rowIndex, colIndex){
                    ...
                    if(record.data.adjudicacion != 'summary'){
                        return  String.format('<div style="vertical-align:middle;text-align:center;"><input style="height:37px;width:37px;" type="checkbox"  {0} {1}></div>',checked, state);
                    }
                    else{
                        return '';
		...
		},
		{
			config:{
                ...
                renderer: function (value, p, record, rowIndex, colIndex){
                    ...
                    if(record.data.llegada_sitio != 'summary'){
                        return  String.format('<div style="vertical-align:middle;text-align:center;"><input style="height:37px;width:37px;" type="checkbox"  {0} {1}></div>',checked, state);
                    }
                    else{
